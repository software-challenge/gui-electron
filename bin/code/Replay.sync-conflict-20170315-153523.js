    ...
    class Board {
        ...
        static StringToDirection(d) {
            switch (d) {
                ...
                case "DOWN_RIGHT": return 1 /* UP_RIGHT */;
        ...
        static NumberToDirection(d) {
            switch (d) {
                ...
                case 1: return 5 /* DOWN_RIGHT */;
                case 2: return 4 /* DOWN_LEFT */;
                case 3: return 3 /* LEFT */;
                case 4: return 2 /* UP_LEFT */;
                case 5: return 1 /* UP_RIGHT */;
            }
        }
        static DirectionToNumber(d) {
            switch (d) {
                case 0 /* RIGHT */: return 0;
                case 5 /* DOWN_RIGHT */: return 1;
                case 4 /* DOWN_LEFT */: return 2;
                case 3 /* LEFT */: return 3;
                case 2 /* UP_LEFT */: return 4;
                case 1 /* UP_RIGHT */: return 5;
            }
        }
...
//# sourceMappingURL=Replay.sync-conflict-20170315-153523.js.map