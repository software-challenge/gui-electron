define(["require", "exports"], function (require, exports) {
    ...
    class Viewer {
        constructor(replay, element, document, window) {
            this.controls = { 'next': null, 'previous': null, 'play': null, 'first': null, 'last': null };
            this.currentMove = 0;
        ...
        render(state) {
            ...
            for (let t of state.board.tiles) {
                for (let f of t.fields) {
                    if (!this.scene.getMeshByName(f.id.toString())) {
...
//# sourceMappingURL=Viewer.sync-conflict-20170315-153715.js.map