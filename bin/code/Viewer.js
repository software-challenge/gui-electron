            ...
            */
            ...
            if (!state.animated || (!animated)) {
                ...
                for (var i = 0; i < state.moves.length; i++) {
                    ...
                    var activePlayer = move.activePlayer == 0 /* RED */ ? this.scene.getMeshByName('player1') : this.scene.getMeshByName('player2');
                    var otherPlayer = move.activePlayer == 0 /* RED */ ? this.scene.getMeshByName('player2') : this.scene.getMeshByName('player1');
                    if (i == 0) {
