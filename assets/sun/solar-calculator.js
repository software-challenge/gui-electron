//https://gist.github.com/mbostock/7784f4b2c7838b893e9b
...
//Additions by @apexys on twitter
navigator.geolocation.getCurrentPosition(located);
window['defaultSolarCalculator'] = solarCalculator([54.32133, 10.13489]);
function located(geolocation) {
    window['localizedSolarCalculator'] = solarCalculator([geolocation.coords.longitude, geolocation.coords.latitude]);
}
window['getSolarCalculator'] = function(){return window['localizedSolarCalculator'] || window['defaultSolarCalculator'];};
